...
void gl_view::draw_text( QString text, QColor color, QPointF coords, QPointF viewer_position,
                         int font_size, Qt::Alignment align, QPointF offset )
{
...
void gl_view::draw_triangle( QPointF pos, float size, QColor color, bool anchor_on_tip,
                             float rotate )
{
...
void gl_view::draw_circle( QPointF anchor_point, float ratio, QColor color, QPointF scale,
                           float rotate, bool keep_scale, int num_segments, bool fill )
{
    if ( keep_scale )
