...
void general_settings::set_content(QString content_name)
{
...
void general_settings::set_visible_general(bool visible)
{
    if (general_widget)
    {
...
void general_settings::set_visible_auto_save(bool visible)
{
    if (auto_save_widget)
    {
...
void general_settings::set_visible_plugins(bool visible)
{
    if (plugins_widget)
    {
...
void general_settings::set_visible_appearance(bool visible)
{
