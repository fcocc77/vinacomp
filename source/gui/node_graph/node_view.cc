...
QJsonObject node_view::get_tree()
{
...
void node_view::restore_tree(QJsonObject _nodes)
{
...
QJsonObject node_view::get_scene_data()
{
    QJsonObject matrix = {
...
void node_view::restore_scene_data(QJsonObject scene_data)
{
