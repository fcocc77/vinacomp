...
void curve_view::popup_setup_ui()
{
    ...
    select_all_action->setIcon(QIcon("resources/images/properties_a.png"));
    ...
    delete_keyframes_action->setIcon(QIcon("resources/images/properties_a.png"));
    ...
    linear_action->setIcon(QIcon("resources/images/properties_a.png"));
    ...
    center_action->setIcon(QIcon("resources/images/properties_a.png"));
